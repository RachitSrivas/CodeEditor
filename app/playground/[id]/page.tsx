...
const MainPlaygroundPage: React.FC = () => {
  ...
  const isLanguageTemplate = ["CPP", "C", "JAVA", "PYTHON", "JAVASCRIPT"].includes(playgroundData?.template || "");
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1">
                  <ResizablePanelGroup
                    ...
                    className="h-full"
                  >
                    <ResizablePanel defaultSize={isPreviewVisible && !isLanguageTemplate ? 50 : 100}>
                      <PlaygroundEditor
